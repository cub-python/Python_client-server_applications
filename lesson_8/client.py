...
from general.variables import DEFAULT_PORT, DEFAULT_IP_ADDRESS, ACTION, \
...
@log
def process_response_reply(message):
    """
...
def main():
    ...
    try:
        ...
        answer = process_response_reply(get_message(transport))
